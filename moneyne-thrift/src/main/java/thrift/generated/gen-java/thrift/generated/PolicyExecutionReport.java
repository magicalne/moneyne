...
public class PolicyExecutionReport implements org.apache.thrift.TBase<PolicyExecutionReport, PolicyExecutionReport._Fields>, java.io.Serializable, Cloneable, Comparable<PolicyExecutionReport> {
  ...
  private static final org.apache.thrift.protocol.TField STEPS_FIELD_DESC = new org.apache.thrift.protocol.TField("steps", org.apache.thrift.protocol.TType.LIST, (short)5);
  ...
  public List<Set<RuleResult>> steps; // required
  ...
  public PolicyExecutionReport(PolicyExecutionReport other) {
    ...
    if (other.isSetSteps()) {
      List<Set<RuleResult>> __this__steps = new ArrayList<Set<RuleResult>>(other.steps.size());
      for (Set<RuleResult> other_element : other.steps) {
        Set<RuleResult> __this__steps_copy = new HashSet<RuleResult>(other_element.size());
        for (RuleResult other_element_element : other_element) {
          __this__steps_copy.add(new RuleResult(other_element_element));
        }
        __this__steps.add(__this__steps_copy);
      }
   ...
   * @see Mode
   */
  public PolicyExecutionReport setMode(Mode mode) {
    this.mode = mode;
    return this;
  }
  ...
  public java.util.Iterator<Set<RuleResult>> getStepsIterator() {
    return (this.steps == null) ? null : this.steps.iterator();
  }

  public void addToSteps(Set<RuleResult> elem) {
    if (this.steps == null) {
      this.steps = new ArrayList<Set<RuleResult>>();
    }
    this.steps.add(elem);
  }

  public List<Set<RuleResult>> getSteps() {
    return this.steps;
  }

  public PolicyExecutionReport setSteps(List<Set<RuleResult>> steps) {
    this.steps = steps;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case STEPS:
      if (value == null) {
        ...
        setSteps((List<Set<RuleResult>>)value);
      }
      break;
  ...
  private static class PolicyExecutionReportStandardScheme extends StandardScheme<PolicyExecutionReport> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, PolicyExecutionReport struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 4: // MODE
            if (schemeField.type == org.apache.thrift.protocol.TType.I32) {
              struct.mode = thrift.generated.Mode.findByValue(iprot.readI32());
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.steps = new ArrayList<Set<RuleResult>>(_list0.size);
                Set<RuleResult> _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  {
                    org.apache.thrift.protocol.TSet _set3 = iprot.readSetBegin();
                    _elem1 = new HashSet<RuleResult>(2*_set3.size);
                    RuleResult _elem4;
                    for (int _i5 = 0; _i5 < _set3.size; ++_i5)
                    {
                      _elem4 = new RuleResult();
                      _elem4.read(iprot);
                      _elem1.add(_elem4);
                    }
                    iprot.readSetEnd();
                  }
                  struct.steps.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PolicyExecutionReport struct) throws org.apache.thrift.TException {
      ...
      if (struct.steps != null) {
        ...
        {
          oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.SET, struct.steps.size()));
          for (Set<RuleResult> _iter6 : struct.steps)
          {
            {
              oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRUCT, _iter6.size()));
              for (RuleResult _iter7 : _iter6)
              {
                _iter7.write(oprot);
              }
              oprot.writeSetEnd();
  ...
  private static class PolicyExecutionReportTupleScheme extends TupleScheme<PolicyExecutionReport> {
      ...
      if (struct.isSetSteps()) {
        {
          ...
          for (Set<RuleResult> _iter8 : struct.steps)
          {
            {
              oprot.writeI32(_iter8.size());
              for (RuleResult _iter9 : _iter8)
              {
                _iter9.write(oprot);
              }
            }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, PolicyExecutionReport struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(4)) {
        {
          org.apache.thrift.protocol.TList _list10 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.SET, iprot.readI32());
          struct.steps = new ArrayList<Set<RuleResult>>(_list10.size);
          Set<RuleResult> _elem11;
          ...
          {
            {
              ...
              _elem11 = new HashSet<RuleResult>(2*_set13.size);
              RuleResult _elem14;
              for (int _i15 = 0; _i15 < _set13.size; ++_i15)
              {
                _elem14 = new RuleResult();
                _elem14.read(iprot);
                _elem11.add(_elem14);
              }
            }
            struct.steps.add(_elem11);
          }
        }
        struct.setStepsIsSet(true);
      }
