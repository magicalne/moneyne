...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField SSN_FIELD_DESC = new org.apache.thrift.protocol.TField("ssn", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  public boolean equals(Person that) {
    ...
    boolean this_present_ssn = true && this.isSetSsn();
    boolean that_present_ssn = true && that.isSetSsn();
    if (this_present_ssn || that_present_ssn) {
      if (!(this_present_ssn && that_present_ssn))
        return false;
      if (!this.ssn.equals(that.ssn))
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_ssn = true && (isSetSsn());
    list.add(present_ssn);
    if (present_ssn)
      list.add(ssn);
  ...
  public int compareTo(Person other) {
    ...
    lastComparison = Boolean.valueOf(isSetSsn()).compareTo(other.isSetSsn());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSsn()) {
